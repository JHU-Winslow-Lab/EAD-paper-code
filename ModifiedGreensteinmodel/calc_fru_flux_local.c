  ...
  for(iFRU = 0;iFRU<NFRU_loc;iFRU++) { 
    for(icleft = 0;icleft<Nclefts_FRU;icleft++) {
			...
			for(iLCC=0;iLCC<NLType_per_cleft;iLCC++){
				if ( ((LType_state_loc[iFRU][icleft][iLCC][index_LCC_states]==O1_LType)||(LType_state_loc[iFRU][icleft][iLCC][index_LCC_states]==O2_LType)) 
					&& (LType_state_loc[iFRU][icleft][iLCC][index_LCC_Vinact]==Oy_LType)
					&& (LType_state_loc[iFRU][icleft][iLCC][index_LCC_phosph]==1))  
				{
