				...
				for(j=0;j<NFRU_sim_factor-1;j++) {
					for(iFRU=0;iFRU<NFRU_sim_low;iFRU++) {
						...
						for(icleft = 0;icleft<Nclefts_FRU;icleft++) {
							...
							LType_state[j*NFRU_sim_low+iFRU][icleft][i][index_LCC_states] = LType_state[iFRU][icleft][i][index_LCC_states];
							LType_state[j*NFRU_sim_low+iFRU][icleft][i][index_LCC_Vinact] = LType_state[iFRU][icleft][i][index_LCC_Vinact];
							LType_state[j*NFRU_sim_low+iFRU][icleft][i][index_LCC_phosph] = LType_state[iFRU][icleft][i][index_LCC_phosph];
							LType_state[j*NFRU_sim_low+iFRU][icleft][i][index_LCC_mode2] = LType_state[iFRU][icleft][i][index_LCC_mode2];
							}
