...
{
	// printf("k_tau_plus_IKs: %f\n",k_tau_plus_IKs);
	// printf("k_tau_minus_IKs: %f\n",k_tau_minus_IKs);
	// printf("delta_V_half_IKs: %f\n",delta_V_half_IKs);
	// printf("k_k_IKs: %f\n",k_k_IKs);
	// printf("k_Gmax_IKs: %f\n",k_Gmax_IKs);

	// k_tau_plus_IKs = 1.0;
	// k_tau_minus_IKs = 1.0;
	// delta_V_half_IKs = 0.0;
	// k_k_IKs = 1.0;
	// k_Gmax_IKs = 0.4;
	...
	//double GKs=0.035*k_Gmax_IKs; // 0.035	G_Ks in Canine C++ code
	double GKs=0.0175*k_Gmax_IKs;
	if(beta_flag){
		GKs*=1.4;
	}
	...
	*/
	//------------Jons et al. 2011 IKs model ------------//
	double IKs_V_shift = -35;
