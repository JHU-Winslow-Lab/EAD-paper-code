...
int LType_state_local[MAX_LOCAL_NFRU][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType];
...
int LType_state_local_hold[MAX_LOCAL_NFRU][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType];
...
void parallel_init_FRU(void)
{
  ...
  for(i=0;i<NFRU_local;i++) {
    ...
    MPI_Irecv(&LType_state_local[i][0][0][0],Nclefts_FRU*NLType_per_cleft*Nindepstates_LType,MPI_INT,source,tag,MPI_COMM_WORLD,&request[reqno]);
    tag++; reqno++;
...
void parallel_send_FRU(void)
{
  ...
  for(i=0;i<NFRU_local;i++) {
    tag=my_rank*1000+i;
    MPI_Isend(&LType_state_local[i][0][0][0],Nclefts_FRU*NLType_per_cleft*Nindepstates_LType,MPI_INT,dest,tag,MPI_COMM_WORLD,&request[reqno]);
    reqno++;
    tag++;
...
void parallel_resume_state(void)
{
  ...
  for(iFRU=0;iFRU<NFRU_local;iFRU++) {
	...
	RyR_state_local[iFRU][icleft][i] = RyR_state_local_hold[iFRU][icleft][i];
      ...
      for (i = 0; i < NLType_per_cleft; i++) {
        LType_state_local[iFRU][icleft][i][index_LCC_states] = LType_state_local_hold[iFRU][icleft][i][index_LCC_states];
        LType_state_local[iFRU][icleft][i][index_LCC_Vinact] = LType_state_local_hold[iFRU][icleft][i][index_LCC_Vinact];
        LType_state_local[iFRU][icleft][i][index_LCC_phosph] = LType_state_local_hold[iFRU][icleft][i][index_LCC_phosph];
        LType_state_local[iFRU][icleft][i][index_LCC_mode2] = LType_state_local_hold[iFRU][icleft][i][index_LCC_mode2];
      }
  ...
  memcpy(LType_state_local, LType_state_local_hold, sizeof(int) * NFRU_local * Nclefts_FRU * NLType_per_cleft * Nindepstates_LType);
...
void parallel_save_state(void)
{
  ...
  for(iFRU=0;iFRU<NFRU_local;iFRU++) {
	...
	RyR_state_local_hold[iFRU][icleft][i] = RyR_state_local[iFRU][icleft][i];
      ...
      for (i = 0; i < NLType_per_cleft; i++) {
        LType_state_local_hold[iFRU][icleft][i][index_LCC_states] = LType_state_local[iFRU][icleft][i][index_LCC_states];
        LType_state_local_hold[iFRU][icleft][i][index_LCC_Vinact] = LType_state_local[iFRU][icleft][i][index_LCC_Vinact];
        LType_state_local_hold[iFRU][icleft][i][index_LCC_phosph] = LType_state_local[iFRU][icleft][i][index_LCC_phosph];
        LType_state_local_hold[iFRU][icleft][i][index_LCC_mode2]  = LType_state_local[iFRU][icleft][i][index_LCC_mode2];
      }
  ...
  memcpy(LType_state_local_hold, LType_state_local, sizeof(int) * NFRU_local * Nclefts_FRU * NLType_per_cleft * Nindepstates_LType);
