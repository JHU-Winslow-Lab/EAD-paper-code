...
double fru_rates_local(int LType_state[Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],
		       ...
		       double LType_rates[Nclefts_FRU][NLType_per_cleft][4],
		       int LType_index[Nclefts_FRU][NLType_per_cleft][4],
		       int LType_length[Nclefts_FRU][NLType_per_cleft], 
		       double LType_Vdep_exitrate[Nclefts_FRU][NLType_per_cleft],
		       ...
		       unsigned long mt_loc[mtN])
{
	...
	for(icleft = 0;icleft<Nclefts_FRU; icleft++) {
	  ...
	  for(iLCC=0;iLCC<NLType_per_cleft;iLCC++){
		if (LType_state[icleft][iLCC][index_LCC_phosph] == 1){
			switch (LType_state[icleft][iLCC][index_LCC_states]) {
				
			case 1:	// if LType	is in state	1
				C0_to_C1 = 4.0*alpha;
				C0_to_CCa0 = gamma_rate;
				LType_rates[icleft][iLCC][0] = (C0_to_C1+C0_to_CCa0);	// sum of rates	leaving	current	state
				LType_rates[icleft][iLCC][1] = C0_to_C1;		// rate	from 1 to 2
				LType_rates[icleft][iLCC][2] = C0_to_CCa0;		// rate	from 1 to 7
				LType_length[icleft][iLCC] = 3;			// length=1+#states	connected to current state
						//		LType_index[icleft][0] = 1			// index(1)	is not used
				LType_index[icleft][iLCC][1] = 2;			// index(2)	state into which rates(2) takes	you	= 2
				LType_index[icleft][iLCC][2] = 7;			// index(3)	state into which rates(3) takes	you	= 7
				break;
			...
			case 2:
				...
				C1_to_C0 =		beta;
				C1_to_CCa1 = aL*gamma_rate;	// = gamma_rate*aL
				LType_rates[icleft][iLCC][0] = (C1_to_C0+C1_to_C2+C1_to_CCa1);
				LType_rates[icleft][iLCC][1] = C1_to_C0;
				LType_rates[icleft][iLCC][2] = C1_to_C2;
				LType_rates[icleft][iLCC][3] = C1_to_CCa1;
				LType_length[icleft][iLCC] = 4;
						//		LType_index[icleft][0] = 2
				LType_index[icleft][iLCC][1] = 1;
				LType_index[icleft][iLCC][2] = 3;
				LType_index[icleft][iLCC][3] = 8;
				break;
			...
			case 3:
				...
				LType_rates[icleft][iLCC][0] = (C2_to_C1+C2_to_C3+C2_to_CCa2);
				LType_rates[icleft][iLCC][1] = C2_to_C1;
				LType_rates[icleft][iLCC][2] = C2_to_C3;
				LType_rates[icleft][iLCC][3] = C2_to_CCa2;
				LType_length[icleft][iLCC] = 4;
				//		LType_index[icleft][0] = 3
				LType_index[icleft][iLCC][1] = 2;
				LType_index[icleft][iLCC][2] = 4;
				LType_index[icleft][iLCC][3] = 9;
				break;
			...
			case 4:
				...
				LType_rates[icleft][iLCC][0] = (C3_to_C2+C3_to_C4+C3_to_CCa3);
				LType_rates[icleft][iLCC][1] = C3_to_C2;
				LType_rates[icleft][iLCC][2] = C3_to_C4;
				LType_rates[icleft][iLCC][3] = C3_to_CCa3;
				LType_length[icleft][iLCC] = 4;
						//		LType_index[icleft][0] = 4
				LType_index[icleft][iLCC][1] = 3;
				LType_index[icleft][iLCC][2] = 5;
				LType_index[icleft][iLCC][3] = 10;
				break;
				
			case 5:
				C4_to_C3 = 4.0*beta;
				C4_to_CCa4 = aL4*gamma_rate;
				LType_rates[icleft][iLCC][1] = C4_to_C3;
				if (LType_state[icleft][iLCC][index_LCC_mode2]==1){
					LType_rates[icleft][iLCC][0] = (C4_to_C3+0.7*fL+C4_to_CCa4);
					LType_rates[icleft][iLCC][2] = 0.7*fL;
				}
				else{
					LType_rates[icleft][iLCC][0] = (C4_to_C3+fL+C4_to_CCa4);
					LType_rates[icleft][iLCC][2] = fL;
				}
				LType_rates[icleft][iLCC][3] = C4_to_CCa4;
				LType_length[icleft][iLCC] = 4;
						//		LType_index[icleft][0] = 5
				LType_index[icleft][iLCC][1] = 4;
				LType_index[icleft][iLCC][2] = 6;
				LType_index[icleft][iLCC][3] = 11;
				break;
				
			case 6:
				if (LType_state[icleft][iLCC][index_LCC_mode2]==1){
					LType_rates[icleft][iLCC][0] = gL/10.0;
					LType_rates[icleft][iLCC][1] = gL/10.0;
				}
				else{
					LType_rates[icleft][iLCC][0] = gL;
					LType_rates[icleft][iLCC][1] = gL;
				}

				LType_length[icleft][iLCC] = 2;
						//		LType_index[icleft][0] = 6
				LType_index[icleft][iLCC][1] = 5;
				break;
				
			case 7:
						//		CCa0_to_C0 = omega	// constant
				CCa0_to_CCa1 = 4.0*alpha_prime;
				LType_rates[icleft][iLCC][0] = (CCa0_to_CCa1+CCa0_to_C0);
				LType_rates[icleft][iLCC][1] = CCa0_to_C0;
				LType_rates[icleft][iLCC][2] = CCa0_to_CCa1;
				LType_length[icleft][iLCC] = 3;
						//		LType_index[icleft][0] = 7
				LType_index[icleft][iLCC][1] = 1;
				LType_index[icleft][iLCC][2] = 8;
				break;
			...
			case 8:
				...
				CCa1_to_CCa2 = 3.0*alpha_prime;
				CCa1_to_CCa0 =		beta_prime;
				LType_rates[icleft][iLCC][0] = (CCa1_to_CCa0+CCa1_to_CCa2+CCa1_to_C1);
				LType_rates[icleft][iLCC][1] = CCa1_to_CCa0;
				LType_rates[icleft][iLCC][2] = CCa1_to_C1;
				LType_rates[icleft][iLCC][3] = CCa1_to_CCa2;
				LType_length[icleft][iLCC] = 4;
						//		LType_index[icleft][0] = 8;
				LType_index[icleft][iLCC][1] = 7;
				LType_index[icleft][iLCC][2] = 2;
				LType_index[icleft][iLCC][3] = 9;
				break;
			...
			case 9:
				...
				CCa2_to_CCa3 = 2.0*alpha_prime;
				CCa2_to_CCa1 = 2.0*beta_prime;
				LType_rates[icleft][iLCC][0] = (CCa2_to_CCa1+CCa2_to_CCa3+CCa2_to_C2);
				LType_rates[icleft][iLCC][1] = CCa2_to_CCa1;
				LType_rates[icleft][iLCC][2] = CCa2_to_C2;
				LType_rates[icleft][iLCC][3] = CCa2_to_CCa3;
				LType_length[icleft][iLCC] = 4;
						//		LType_index[icleft][0] = 9;
				LType_index[icleft][iLCC][1] = 8;
				LType_index[icleft][iLCC][2] = 3;
				LType_index[icleft][iLCC][3] = 10;
				break;
			...
			case 10:		
				...
				CCa3_to_CCa4 =		alpha_prime;
				CCa3_to_CCa2 = 3.0*beta_prime;
				LType_rates[icleft][iLCC][0] = (CCa3_to_CCa2+CCa3_to_CCa4+CCa3_to_C3);
				LType_rates[icleft][iLCC][1] = CCa3_to_CCa2;
				LType_rates[icleft][iLCC][2] = CCa3_to_C3;
				LType_rates[icleft][iLCC][3] = CCa3_to_CCa4;
				LType_length[icleft][iLCC] = 4;
						//		LType_index[icleft][0] = 10
				LType_index[icleft][iLCC][1] = 9;
				LType_index[icleft][iLCC][2] = 4;
				LType_index[icleft][iLCC][3] = 11;
				break;
			...
			case 11:
				...
				CCa4_to_CCa3 = 4.0*beta_prime;
				LType_rates[icleft][iLCC][0] = (CCa4_to_CCa3+CCa4_to_C4+fLprime);
				LType_rates[icleft][iLCC][1] = CCa4_to_CCa3;
				LType_rates[icleft][iLCC][2] = CCa4_to_C4;
				LType_rates[icleft][iLCC][3] = fLprime;
				LType_length[icleft][iLCC] = 4;
						//		LType_index[icleft][0] = 11
				LType_index[icleft][iLCC][1] = 10;
				LType_index[icleft][iLCC][2] = 5;
				LType_index[icleft][iLCC][3] = 12;
				break;
				
			case 12:		
				LType_rates[icleft][iLCC][0] = gLprime;
				LType_rates[icleft][iLCC][1] = gLprime;
				LType_length[icleft][iLCC] = 2;
						//		LType_index[icleft][0] = 12
				LType_index[icleft][iLCC][1] = 11;
				break;
				
			default: //	Unknown	state
				fprintf(stderr,"Unknown state %d in LCC in cleft %d local\n",
					LType_state[icleft][iLCC][index_LCC_states],icleft);
				break;
			}
		}
	  }
	...
	for(icleft = 0;icleft<Nclefts_FRU;icleft++) {
		for(iLCC = 0;iLCC<NLType_per_cleft;iLCC++){
			if (LType_state[icleft][iLCC][index_LCC_phosph] == 1){
				switch (LType_state[icleft][iLCC][index_LCC_Vinact]) {
				case Oy_LType:
					LType_Vdep_exitrate[icleft][iLCC]	= (1.0-yCa_inf)/tau_yCa;
					break;
				case Cy_LType:
					LType_Vdep_exitrate[icleft][iLCC]	= yCa_inf/tau_yCa;
					break;
				default: //	Unknown	state
					fprintf(stderr,"Unknown state %d in LCC Vinact in cleft %d local\n",
						LType_state[icleft][iLCC][index_LCC_Vinact],icleft);
					break;
				}
			}
	...
	for(icleft = 0;icleft<Nclefts_FRU;icleft++) {
		...
		if ((beta_flag==0) && (LType_state[icleft][0][index_LCC_phosph] == 0)){
			k12/=10.0;
		}
...
*/
	...
	for(icleft = 0;	icleft <Nclefts_FRU; icleft++)	{
		for(iLCC = 0;iLCC<NLType_per_cleft;iLCC++){
			if(LType_state[icleft][iLCC][index_LCC_phosph]==1){
				max_rate = max(max_rate,LType_rates[icleft][iLCC][0]);	// Calc. max of	sum	of exit	rates
				max_rate = max(max_rate,LType_Vdep_exitrate[icleft][iLCC]);
			}
		}
