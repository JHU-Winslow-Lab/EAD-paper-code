...
#define NLType_per_cleft 1 //maximum
#define Nindepstates_LType 4 // 0:Ca depdent, //1 V dependent // 2 phosphorylation [0,1] // 3 mode[0,1,2]
...
#define NFRU_sim_low 1500
#define NFRU_scale_low 20.0 // ratio of 30000/NFRU_sim_low
#define NFRU_sim_high 1500
#define NFRU_scale_high 20.0 // ratio of 30000/NFRU_sim_high

// for array sizes, has to be NFRU_sim_max> NFRU_sim_high
// MAX_LOCAL_NFRU should probably be the same as NFRU_sim_max
#define NFRU_sim_max 1500
#define MAX_LOCAL_NFRU 1500
...
// //original for the ctrl condition
// #define ic_dir "ic/stable_1500"
...
#define ic_dir "ic/stable_Jons2011IKsbeta_f07_serca20"
#define ic_states_file "r_states.0.txt"
#define ic_FRU_file "r_FRU.0.txt"
#define ic_LCh_file "r_LCh.0.txt"
#define ic_RyR_file "r_RyR.0.txt"
#define ic_Ito2_file "r_Ito2.0.txt"
#define ic_seeds_file "r_randomseeds.0.txt"
...
// LQTS1 reading filenames and index
#define LQTS_dir "LQTSparams/"
#define LQTS_file "LQTSparameters.txt"
// #define LQTS_index 58

// define  the beta adrenergic condtion flag
#define beta_flag 1
...
void initialize_state(double[N],double[NFRU_sim_max][Nstates_FRU],int[NFRU_sim_max][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int[NFRU_sim_max][Nclefts_FRU][NRyRs_per_cleft],int[NFRU_sim_max][Nclefts_FRU],unsigned long[NFRU_sim_max][mtN+1],int[NFRU_sim_max]);
...
FILE *open_currents(const int,const int);
FILE *open_otherstates(const int,const int);
FILE *open_states(const int, const int);
...
void write_fru_props(FILE *[],FILE *[],FILE *,const double,const double,const double,const double,double [NFRU_sim_max][Nstates_FRU],int [NFRU_sim_max][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int [NFRU_sim_max][Nclefts_FRU][NRyRs_per_cleft],int [NFRU_sim_max][Nclefts_FRU]);

double fru_rates_local(int[Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int[Nclefts_FRU][NRyRs_per_cleft],int[Nclefts_FRU],const double[Nstates_FRUdep],const double[Nstates_FRU],double[Nclefts_FRU][NLType_per_cleft][4],int[Nclefts_FRU][NLType_per_cleft][4],
		       int[Nclefts_FRU][NLType_per_cleft],double[Nclefts_FRU][NLType_per_cleft],double[Nclefts_FRU][NRyRs_per_cleft][4],int[Nclefts_FRU][NRyRs_per_cleft][4],int[Nclefts_FRU][NRyRs_per_cleft],double[Nclefts_FRU],int *,unsigned long[mtN+1]);
...
void simfru_local(const double, const double, double[Nstates_FRUdep], double[Nstates_FRUdep], int[Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int[Nclefts_FRU][NRyRs_per_cleft],int[Nclefts_FRU],double[Nstates_FRU],int *,unsigned long [mtN+1]);

void dynamicFRU(const double,double[N],double[NFRU_sim_max][Nstates_FRU],int[NFRU_sim_max][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int[NFRU_sim_max][Nclefts_FRU][NRyRs_per_cleft],int[NFRU_sim_max][Nclefts_FRU],int[NFRU_sim_max],unsigned long[NFRU_sim_max][mtN+1],const double,const double);
void lastcall(double,double[N],double[Ncur]);
void initialize_ran(unsigned long[NFRU_sim_max][mtN+1],int[NFRU_sim_max],int);
void restart_data(const int,double[N],double[NFRU_sim_max][Nstates_FRU],int[NFRU_sim_max][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int[NFRU_sim_max][Nclefts_FRU][NRyRs_per_cleft],int[NFRU_sim_max][Nclefts_FRU],unsigned long[NFRU_sim_max][mtN+1],int mti[NFRU_sim_max]);
...
void parallel_get_FRUs(double[NFRU_sim_max][Nstates_FRU],int[NFRU_sim_max][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int[NFRU_sim_max][Nclefts_FRU][NRyRs_per_cleft],int[NFRU_sim_max][Nclefts_FRU],unsigned long[NFRU_sim_max][mtN+1],int[NFRU_sim_max]);
...
void initialize_mpi_state(double[NFRU_sim_max][Nstates_FRU],int[NFRU_sim_max][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int[NFRU_sim_max][Nclefts_FRU][NRyRs_per_cleft],int[NFRU_sim_max][Nclefts_FRU],int[NFRU_sim_max],unsigned long[NFRU_sim_max][mtN+1]);
void calc_fru_flux_local(int,int[NFRU_sim_max][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int[NFRU_sim_max][Nclefts_FRU],double[NFRU_sim_max][Nstates_FRU],double[4]);
void parallel_calc_fru_avg(void);
void parallel_calc_fru_flux(void);
void calc_fru_avg_local(double[11],int,double[MAX_LOCAL_NFRU][Nstates_FRU],int[MAX_LOCAL_NFRU][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType],int[MAX_LOCAL_NFRU][Nclefts_FRU][NRyRs_per_cleft],int[MAX_LOCAL_NFRU][Nclefts_FRU]);

// reading LQTS1 parameter function (implemented in data_io.c)
void Read_LQTS_data(int);
...
extern int LType_state_local[MAX_LOCAL_NFRU][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType];
...
extern double FRU_states_local_hold[MAX_LOCAL_NFRU][Nstates_FRU];// CaJSR and then 4 CaSS in FRU
extern int LType_state_local_hold[MAX_LOCAL_NFRU][Nclefts_FRU][NLType_per_cleft][Nindepstates_LType];
...
//LQTS1 mutation related parameters/variables
extern double k_tau_plus_IKs;
extern double k_tau_minus_IKs;
extern double delta_V_half_IKs;
extern double k_k_IKs;
extern double k_Gmax_IKs;
